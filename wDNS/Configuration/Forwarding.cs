...
{
    public int[] Ports { get; set; } = [49152, 60999];

    public required string[] Remotes { get; set; }

    public int Timeout { get; set; }

    public bool PrintQueryBytesOnReceiveError { get; set; }
    public bool PrintRequestBytesOnSending { get; set; }
    public bool PrintResponseOnReceive { get; set; }
